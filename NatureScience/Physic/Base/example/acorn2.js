(function (global, factory) {
  ...
  var types$1 = {
    ...
    semi: new TokenType(";", beforeExpr),
      ...
      // editable: ok
    pipe: new TokenType("|>", beforeExpr),
    pipeResult: new TokenType("%%"),
  ...
  pp$8.parseLabeledStatement = function(node, maybeName, expr, context) {
    ...
    // editable: ok
    pp$8.parsePipeStatement = function( fooNode ) {
        ...
        while (this.type === types$1.pipe) {
            this.eat(types$1.pipe)
  ...
  pp.getTokenFromCode = function(code) {
    ...
    case 124: // '|'
        this.pos += 2;
        return this.finishToken(types$1.pipe)
            // editable: ok
    case 37: // '%%'
        if ( this.input.charCodeAt(this.pos + 1) === 37 ) {
            this.pos += 2;
            return this.finishToken(types$1.pipeResult );
        }
