...
| Windows                                                      |
| :----------------------------------------------------------- |
| [Исполняемые в windows(Bat) файлы](./Windows/01-BatFiles.md) |
| [Администрирование Windows](./Windows/02-Base.md)            |
...
| [Алгоритмы и паттерны](./Programming/Base/02-Algoritms.md)                     |
...
Docker, собирает все зависимости в кучу:

| Docker                                                  |
| :------------------------------------------------------ |
| [Docker - определения](./Programming/Docker/00-Base.md) |
...
| SQL(сиквел)                                                       |
| :---------------------------------------------------------------- |
| [SQL - определения](./Programming/SQL/03-BaseDefinition.md)       |
| [SQL - НФ(нормальные формы)](./Programming/SQL/01-NormalForms.md) |
...
| Личное                                           | Гитара                                 |
| :----------------------------------------------- | :------------------------------------- |
| [Книги](./Personal/Books.md)                     | [Основы](./Personal/Guitar/00-Base.md) |
